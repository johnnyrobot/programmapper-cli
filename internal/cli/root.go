...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newCollegesCmd(flags))
	rootCmd.AddCommand(newCoursesCmd(flags))
	rootCmd.AddCommand(newProgramMapsCmd(flags))
	rootCmd.AddCommand(newProgramsCmd(flags))
	rootCmd.AddCommand(newSiteContentsCmd(flags))
	...
	rootCmd.AddCommand(newNovelBottlenecksCmd(flags))
	rootCmd.AddCommand(newNovelCompareCmd(flags))
	rootCmd.AddCommand(newNovelCourseProgramsCmd(flags))
	rootCmd.AddCommand(newNovelDiffYearsCmd(flags))
	rootCmd.AddCommand(newNovelPlanCmd(flags))
	rootCmd.AddCommand(newNovelTransferOptionsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newInterestClustersPromotedCmd(flags))
	rootCmd.AddCommand(newMetaPromotedCmd(flags))
	rootCmd.AddCommand(newOccupationsPromotedCmd(flags))
