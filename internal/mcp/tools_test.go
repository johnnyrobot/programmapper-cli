...
func TestMCPPathResolutionMatchesCLIResolverWithHomeEnv(t *testing.T) {
	...
	t.Setenv("PROGRAMMAPPER_HOME", root)
...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "programmapper-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "programmapper-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"PROGRAMMAPPER_CONFIG",
		"PROGRAMMAPPER_CONFIG_DIR",
		"PROGRAMMAPPER_DATA_DIR",
		"PROGRAMMAPPER_STATE_DIR",
		"PROGRAMMAPPER_CACHE_DIR",
		"PROGRAMMAPPER_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
